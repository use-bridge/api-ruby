  ...
  module Services
    module Payments
      class Client
        ...
        #
        # @return [Bridge_api::Services::Payments::Types::ServicePaymentsListV1Response]
        def list_service_payments(request_options: {}, **params)
          ...
          if code.between?(200, 299)
            (response.body.to_s.empty? ? nil : Bridge_api::Services::Payments::Types::ServicePaymentsListV1Response.load(response.body))
          else
