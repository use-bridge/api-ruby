    ...
    module V2
      module Types
        class ServiceUpdateV2ResponseLocation < Internal::Types::Model
          ...
          field :state, -> { Bridge_api::Services::V2::Types::ServiceUpdateV2ResponseLocationFieldState }, optional: false, nullable: false

          field :postal_code, -> { String }, optional: true, nullable: false, api_name: "postalCode"

          field :country, -> { Bridge_api::Services::V2::Types::ServiceUpdateV2ResponseLocationFieldCountry }, optional: true, nullable: false
        end
      end
    end
  end
