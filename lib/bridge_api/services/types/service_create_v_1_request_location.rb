  ...
  module Services
    module Types
      class ServiceCreateV1RequestLocation < Internal::Types::Model
        ...
        field :state, -> { Bridge_api::Services::Types::ServiceCreateV1RequestLocationFieldState }, optional: false, nullable: false

        field :postal_code, -> { String }, optional: true, nullable: false, api_name: "postalCode"

        field :country, -> { Bridge_api::Services::Types::ServiceCreateV1RequestLocationFieldCountry }, optional: true, nullable: false
      end
    end
  end
end
