  ...
  module Patients
    module Types
      class PatientStreamV1ResponseAddress < Internal::Types::Model
        ...
        field :state, -> { Bridge_api::Patients::Types::PatientStreamV1ResponseAddressFieldState }, optional: false, nullable: false

        field :postal_code, -> { String }, optional: true, nullable: false, api_name: "postalCode"

        field :country, -> { Bridge_api::Patients::Types::PatientStreamV1ResponseAddressFieldCountry }, optional: true, nullable: false
      end
    end
  end
end
