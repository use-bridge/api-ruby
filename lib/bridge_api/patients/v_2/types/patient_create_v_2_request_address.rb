    ...
    module V2
      module Types
        class PatientCreateV2RequestAddress < Internal::Types::Model
          ...
          field :state, -> { Bridge_api::Patients::V2::Types::PatientCreateV2RequestAddressFieldState }, optional: false, nullable: false

          field :postal_code, -> { String }, optional: false, nullable: false, api_name: "postalCode"

          field :country, -> { Bridge_api::Patients::V2::Types::PatientCreateV2RequestAddressFieldCountry }, optional: true, nullable: false
        end
      end
    end
  end
