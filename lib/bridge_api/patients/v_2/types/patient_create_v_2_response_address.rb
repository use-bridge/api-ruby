    ...
    module V2
      module Types
        class PatientCreateV2ResponseAddress < Internal::Types::Model
          ...
          field :state, -> { Bridge_api::Patients::V2::Types::PatientCreateV2ResponseAddressFieldState }, optional: false, nullable: false

          field :postal_code, -> { String }, optional: true, nullable: false, api_name: "postalCode"

          field :country, -> { Bridge_api::Patients::V2::Types::PatientCreateV2ResponseAddressFieldCountry }, optional: true, nullable: false
        end
      end
    end
  end
