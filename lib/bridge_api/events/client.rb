...
module Bridge_api
  module Events
    class Client
      ...
      # @option params [Bridge_api::Events::Types::EventsListV1OrderCreatedAt, nil] :order_created_at
      ...
      #
      # @return [Bridge_api::Events::Types::EventsListV1Response]
      def list_events(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : Bridge_api::Events::Types::EventsListV1Response.load(response.body))
        else
      ...
      #
      # @return [Bridge_api::Events::Types::EventGetV1Response]
      def get_event(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : Bridge_api::Events::Types::EventGetV1Response.load(response.body))
        else
          error_class = Bridge_api::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
