  ...
  module Providers
    module Types
      class ProviderPostV1ResponseSuccessful < Internal::Types::Model
        ...
        field :provider_type, -> { Bridge_api::Providers::Types::ProviderPostV1ResponseSuccessfulElementProviderType }, optional: false, nullable: false, api_name: "providerType"
      end
    end
  end
end
