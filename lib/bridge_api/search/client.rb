...
module Bridge_api
  module Search
    class Client
      ...
      # @param params [Bridge_api::Search::Types::SearchPayerV1Request]
      ...
      #   )
      #
      # @return [Bridge_api::Search::Types::SearchPayerV1Response]
      def payer_search(request_options: {}, **params)
        ...
        request = Bridge_api::Internal::JSON::Request.new(
          ...
          body: Bridge_api::Search::Types::SearchPayerV1Request.new(params).to_h,
        ...
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : Bridge_api::Search::Types::SearchPayerV1Response.load(response.body))
        else
