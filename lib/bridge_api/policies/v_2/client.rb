  ...
  module Policies
    module V2
      class Client
        ...
        # @param params [Bridge_api::Policies::V2::Types::PolicyCreateV2Request]
        ...
        #   )
        #
        # @return [Bridge_api::Policies::V2::Types::PolicyCreateV2Response]
        def create_policy(request_options: {}, **params)
          ...
          request = Bridge_api::Internal::JSON::Request.new(
            ...
            body: Bridge_api::Policies::V2::Types::PolicyCreateV2Request.new(params).to_h,
          ...
          if code.between?(200, 299)
            (response.body.to_s.empty? ? nil : Bridge_api::Policies::V2::Types::PolicyCreateV2Response.load(response.body))
          else
