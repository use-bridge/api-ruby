...
module Bridge_api
  module Notes
    module Types
      class NoteCreateV1RequestData < Internal::Types::Model
        ...
        field :monitoring_data, -> { Internal::Types::Array[Bridge_api::Notes::Types::NoteCreateV1RequestDataFieldMonitoringDatum] }, optional: true, nullable: false, api_name: "MONITORING_DATA"

        field :scored_assessments, -> { Internal::Types::Array[Bridge_api::Notes::Types::NoteCreateV1RequestDataFieldScoredAssessment] }, optional: true, nullable: false, api_name: "SCORED_ASSESSMENTS"
