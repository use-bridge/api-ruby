  ...
  module Billing
    module Fees
      class Client
        ...
        # @option params [Bridge_api::Billing::Fees::Types::FeesListV1FilterStatus, nil] :filter_status
        ...
        #
        # @return [Bridge_api::Billing::Fees::Types::FeesListV1Response]
        def list_fees(request_options: {}, **params)
          ...
          if code.between?(200, 299)
            (response.body.to_s.empty? ? nil : Bridge_api::Billing::Fees::Types::FeesListV1Response.load(response.body))
          else
        ...
        #
        # @param request_options [Hash]
        # @param params [Bridge_api::Billing::Fees::Types::FeeCreateV1Request]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        #   )
        #
        # @return [Bridge_api::Billing::Fees::Types::FeeCreateV1Response]
        def create_fee(request_options: {}, **params)
          ...
          request = Bridge_api::Internal::JSON::Request.new(
            ...
            method: "POST",
            path: "/api/fees/v2",
            body: Bridge_api::Billing::Fees::Types::FeeCreateV1Request.new(params).to_h,
            request_options: request_options
          )
          begin
            response = @client.send(request)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            (response.body.to_s.empty? ? nil : Bridge_api::Billing::Fees::Types::FeeCreateV1Response.load(response.body))
          else
            error_class = Bridge_api::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        #
        # @return [Bridge_api::Billing::Fees::Types::FeeCaptureStripeV1Response]
        def capture_stripe_fee(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            (response.body.to_s.empty? ? nil : Bridge_api::Billing::Fees::Types::FeeCaptureStripeV1Response.load(response.body))
          else
            error_class = Bridge_api::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        #
        # @return [Bridge_api::Billing::Fees::Types::FeeRefundStripeV1Response]
        def refund_stripe_fee(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            (response.body.to_s.empty? ? nil : Bridge_api::Billing::Fees::Types::FeeRefundStripeV1Response.load(response.body))
          else
            error_class = Bridge_api::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
