  ...
  module ProviderEligibility
    module Types
      class ProviderEligibilityCreateV1ResponseLocation < Internal::Types::Model
        ...
        field :state, -> { Bridge_api::ProviderEligibility::Types::ProviderEligibilityCreateV1ResponseLocationFieldState }, optional: false, nullable: false

        field :postal_code, -> { String }, optional: true, nullable: false, api_name: "postalCode"

        field :country, -> { Bridge_api::ProviderEligibility::Types::ProviderEligibilityCreateV1ResponseLocationFieldCountry }, optional: true, nullable: false
      end
    end
  end
end
