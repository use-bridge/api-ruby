  ...
  module ProviderEligibility
    module Types
      class ProviderEligibilityCreateV1RequestLocation < Internal::Types::Model
        ...
        field :state, -> { Bridge_api::ProviderEligibility::Types::ProviderEligibilityCreateV1RequestLocationFieldState }, optional: false, nullable: false

        field :postal_code, -> { String }, optional: true, nullable: false, api_name: "postalCode"

        field :country, -> { Bridge_api::ProviderEligibility::Types::ProviderEligibilityCreateV1RequestLocationFieldCountry }, optional: true, nullable: false
      end
    end
  end
end
