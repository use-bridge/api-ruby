    ...
    module EstimateCharges
      module Types
        class EstimateChargeCaptureStripeV1Response < Internal::Types::Model
          ...
          field :status, -> { BridgeApi::Billing::EstimateCharges::Types::EstimateChargeCaptureStripeV1ResponseStatus }, optional: false, nullable: false

          field :stripe, -> { BridgeApi::Billing::EstimateCharges::Types::EstimateChargeCaptureStripeV1ResponseStripe }, optional: true, nullable: false
        end
      end
    end
  end
