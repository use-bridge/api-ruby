...
module BridgeApi
  module Providers
    class Client
      ...
      # @param params [BridgeApi::Providers::Types::ProviderPostV1Request]
      ...
      #   }])
      #
      # @return [BridgeApi::Providers::Types::ProviderPostV1Response]
      def submit_providers(request_options: {}, **params)
        ...
        request = BridgeApi::Internal::JSON::Request.new(
          ...
          body: BridgeApi::Providers::Types::ProviderPostV1Request.new(params).to_h,
        ...
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Providers::Types::ProviderPostV1Response.load(response.body))
        else
      ...
      #
      # @return [BridgeApi::Providers::Types::ProvidersListV1Response]
      def list_providers(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Providers::Types::ProvidersListV1Response.load(response.body))
        else
          error_class = BridgeApi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [BridgeApi::Providers::Types::ProviderGetV1Response]
      def get_provider(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Providers::Types::ProviderGetV1Response.load(response.body))
        else
          error_class = BridgeApi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @param request_options [Hash]
      # @param params [BridgeApi::Providers::Types::ProviderUpdateV1Request]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #
      # @return [BridgeApi::Providers::Types::ProviderUpdateV1Response]
      def update_provider(request_options: {}, **params)
        ...
        request = BridgeApi::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "/api/providers/#{URI.encode_uri_component(params[:id].to_s)}",
          body: BridgeApi::Providers::Types::ProviderUpdateV1Request.new(body_params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Providers::Types::ProviderUpdateV1Response.load(response.body))
        else
          error_class = BridgeApi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @return [BridgeApi::Enrollment::Client]
      def enrollment
        @enrollment ||= BridgeApi::Providers::Enrollment::Client.new(client: @client)
      end
    end
  end
end
