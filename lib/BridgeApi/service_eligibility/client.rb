...
module BridgeApi
  module ServiceEligibility
    class Client
      ...
      #
      # @return [BridgeApi::ServiceEligibility::Types::ServiceEligibilityGetV1Response]
      def get_service_eligibility(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::ServiceEligibility::Types::ServiceEligibilityGetV1Response.load(response.body))
        else
          error_class = BridgeApi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      def v_2
        @v_2 ||= BridgeApi::ServiceEligibility::V2::Client.new(client: @client)
      end
    end
  end
end
