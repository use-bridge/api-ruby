    ...
    module V2
      module Types
        class ServiceEligibilityCreateV2ResponsePatientResponsibility < Internal::Types::Model
          ...
          field :deductible_type, -> { BridgeApi::ServiceEligibility::V2::Types::ServiceEligibilityCreateV2ResponsePatientResponsibilityFieldDeductibleType }, optional: true, nullable: false, api_name: "deductibleType"
