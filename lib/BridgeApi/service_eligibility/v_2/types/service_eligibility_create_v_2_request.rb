    ...
    module V2
      module Types
        class ServiceEligibilityCreateV2Request < Internal::Types::Model
          ...
          field :state, -> { BridgeApi::ServiceEligibility::V2::Types::ServiceEligibilityCreateV2RequestState }, optional: false, nullable: false

          field :clinical_info, -> { BridgeApi::ServiceEligibility::V2::Types::ServiceEligibilityCreateV2RequestClinicalInfo }, optional: true, nullable: false, api_name: "clinicalInfo"
        end
      end
    end
  end
