    ...
    module V2
      module Types
        class ServiceCancelV2ResponseLocation < Internal::Types::Model
          ...
          field :state, -> { BridgeApi::Services::V2::Types::ServiceCancelV2ResponseLocationFieldState }, optional: false, nullable: false

          field :postal_code, -> { String }, optional: true, nullable: false, api_name: "postalCode"

          field :country, -> { BridgeApi::Services::V2::Types::ServiceCancelV2ResponseLocationFieldCountry }, optional: true, nullable: false
        end
      end
    end
  end
