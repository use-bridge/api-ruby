    ...
    module V2
      module Types
        class ServiceCreateV2RequestLocation < Internal::Types::Model
          ...
          field :state, -> { BridgeApi::Services::V2::Types::ServiceCreateV2RequestLocationFieldState }, optional: false, nullable: false

          field :postal_code, -> { String }, optional: true, nullable: false, api_name: "postalCode"

          field :country, -> { BridgeApi::Services::V2::Types::ServiceCreateV2RequestLocationFieldCountry }, optional: true, nullable: false
        end
      end
    end
  end
