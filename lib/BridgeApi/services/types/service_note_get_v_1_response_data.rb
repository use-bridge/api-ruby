  ...
  module Services
    module Types
      class ServiceNoteGetV1ResponseData < Internal::Types::Model
        ...
        field :monitoring_data, -> { Internal::Types::Array[BridgeApi::Services::Types::ServiceNoteGetV1ResponseDataFieldMonitoringDatum] }, optional: true, nullable: false, api_name: "MONITORING_DATA"

        field :scored_assessments, -> { Internal::Types::Array[BridgeApi::Services::Types::ServiceNoteGetV1ResponseDataFieldScoredAssessment] }, optional: true, nullable: false, api_name: "SCORED_ASSESSMENTS"
