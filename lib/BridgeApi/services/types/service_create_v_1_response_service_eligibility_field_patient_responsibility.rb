  ...
  module Services
    module Types
      class ServiceCreateV1ResponseServiceEligibilityFieldPatientResponsibility < Internal::Types::Model
        ...
        field :deductible_type, -> { BridgeApi::Services::Types::ServiceCreateV1ResponseServiceEligibilityFieldPatientResponsibilityFieldDeductibleType }, optional: true, nullable: false, api_name: "deductibleType"
