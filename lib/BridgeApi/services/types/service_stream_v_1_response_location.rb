  ...
  module Services
    module Types
      class ServiceStreamV1ResponseLocation < Internal::Types::Model
        ...
        field :state, -> { BridgeApi::Services::Types::ServiceStreamV1ResponseLocationFieldState }, optional: false, nullable: false

        field :postal_code, -> { String }, optional: true, nullable: false, api_name: "postalCode"

        field :country, -> { BridgeApi::Services::Types::ServiceStreamV1ResponseLocationFieldCountry }, optional: true, nullable: false
      end
    end
  end
end
