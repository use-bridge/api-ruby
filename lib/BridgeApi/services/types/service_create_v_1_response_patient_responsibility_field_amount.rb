  ...
  module Services
    module Types
      class ServiceCreateV1ResponsePatientResponsibilityFieldAmount < Internal::Types::Model
        ...
        field :deductible_type, -> { BridgeApi::Services::Types::ServiceCreateV1ResponsePatientResponsibilityFieldAmountFieldDeductibleType }, optional: true, nullable: false, api_name: "deductibleType"
