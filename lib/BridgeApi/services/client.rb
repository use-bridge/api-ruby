...
module BridgeApi
  module Services
    class Client
      ...
      # @option params [Array[BridgeApi::Services::Types::ServicesListV1FilterStatusElement], nil] :filter_status
      # @option params [Array[String], nil] :filter_provider_id
      # @option params [BridgeApi::Services::Types::ServicesListV1OrderCreatedAt, nil] :order_created_at
      # @option params [BridgeApi::Services::Types::ServicesListV1OrderDateOfService, nil] :order_date_of_service
      ...
      #
      # @return [BridgeApi::Services::Types::ServicesListV1Response]
      def list_services(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Services::Types::ServicesListV1Response.load(response.body))
        else
          error_class = BridgeApi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @param request_options [Hash]
      # @param params [BridgeApi::Services::Types::ServiceCreateV1Request]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #   )
      #
      # @return [BridgeApi::Services::Types::ServiceCreateV1Response]
      def create_service(request_options: {}, **params)
        ...
        request = BridgeApi::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "/api/services",
          body: BridgeApi::Services::Types::ServiceCreateV1Request.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Services::Types::ServiceCreateV1Response.load(response.body))
        else
          error_class = BridgeApi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [BridgeApi::Services::Types::ServiceGetV1Response]
      def get_service(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Services::Types::ServiceGetV1Response.load(response.body))
        else
          error_class = BridgeApi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [BridgeApi::Services::Types::ServiceNoteGetV1Response]
      def get_service_note(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Services::Types::ServiceNoteGetV1Response.load(response.body))
        else
          error_class = BridgeApi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      def payments
        @payments ||= BridgeApi::Services::Payments::Client.new(client: @client)
      end

      # @return [BridgeApi::V2::Client]
      def v_2
        @v_2 ||= BridgeApi::Services::V2::Client.new(client: @client)
      end
    end
  end
end
