...
module BridgeApi
  module Policies
    class Client
      ...
      #
      # @return [BridgeApi::Policies::Types::PolicyGetV1Response]
      def get_policy(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Policies::Types::PolicyGetV1Response.load(response.body))
        else
      ...
      def v_2
        @v_2 ||= BridgeApi::Policies::V2::Client.new(client: @client)
      end
    end
  end
end
