  ...
  module Patients
    module Types
      class PatientUpdateV1ResponseAddress < Internal::Types::Model
        ...
        field :state, -> { BridgeApi::Patients::Types::PatientUpdateV1ResponseAddressFieldState }, optional: false, nullable: false

        field :postal_code, -> { String }, optional: true, nullable: false, api_name: "postalCode"

        field :country, -> { BridgeApi::Patients::Types::PatientUpdateV1ResponseAddressFieldCountry }, optional: true, nullable: false
      end
    end
  end
end
