...
module BridgeApi
  module Patients
    class Client
      ...
      #
      # @return [BridgeApi::Patients::Types::PatientsListV1Response]
      def list_patients(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Patients::Types::PatientsListV1Response.load(response.body))
        else
          error_class = BridgeApi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @param request_options [Hash]
      # @param params [BridgeApi::Patients::Types::PatientUpdateV1Request]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #
      # @return [BridgeApi::Patients::Types::PatientUpdateV1Response]
      def update_patient(request_options: {}, **params)
        ...
        request = BridgeApi::Internal::JSON::Request.new(
          ...
          body: BridgeApi::Patients::Types::PatientUpdateV1Request.new(body_params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Patients::Types::PatientUpdateV1Response.load(response.body))
        else
          error_class = BridgeApi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      def v_2
        @v_2 ||= BridgeApi::Patients::V2::Client.new(client: @client)
      end
    end
  end
end
