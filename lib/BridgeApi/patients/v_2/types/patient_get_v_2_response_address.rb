    ...
    module V2
      module Types
        class PatientGetV2ResponseAddress < Internal::Types::Model
          ...
          field :state, -> { BridgeApi::Patients::V2::Types::PatientGetV2ResponseAddressFieldState }, optional: false, nullable: false

          field :postal_code, -> { String }, optional: true, nullable: false, api_name: "postalCode"

          field :country, -> { BridgeApi::Patients::V2::Types::PatientGetV2ResponseAddressFieldCountry }, optional: true, nullable: false
        end
      end
    end
  end
