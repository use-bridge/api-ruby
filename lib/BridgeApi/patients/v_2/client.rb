  ...
  module Patients
    module V2
      class Client
        ...
        # @param params [BridgeApi::Patients::V2::Types::PatientCreateV2Request]
        ...
        #   )
        #
        # @return [BridgeApi::Patients::V2::Types::PatientCreateV2Response]
        def create_patient(request_options: {}, **params)
          ...
          request = BridgeApi::Internal::JSON::Request.new(
            ...
            body: BridgeApi::Patients::V2::Types::PatientCreateV2Request.new(params).to_h,
          ...
          if code.between?(200, 299)
            (response.body.to_s.empty? ? nil : BridgeApi::Patients::V2::Types::PatientCreateV2Response.load(response.body))
          else
        ...
        #
        # @return [BridgeApi::Patients::V2::Types::PatientGetV2Response]
        def get_patient(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            (response.body.to_s.empty? ? nil : BridgeApi::Patients::V2::Types::PatientGetV2Response.load(response.body))
          else
            error_class = BridgeApi::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
