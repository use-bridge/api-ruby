...
module BridgeApi
  module Payments
    class Client
      ...
      # @option params [BridgeApi::Payments::Types::PaymentsListV1FilterType, nil] :filter_type
      # @option params [BridgeApi::Payments::Types::PaymentsListV1OrderPaidAt, nil] :order_paid_at
      ...
      #
      # @return [BridgeApi::Payments::Types::PaymentsListV1Response]
      def list_payments(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Payments::Types::PaymentsListV1Response.load(response.body))
        else
      ...
      # @param request_options [Hash]
      # @param params [BridgeApi::Payments::Types::PaymentCreateV1Request]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #   )
      #
      # @return [BridgeApi::Payments::Types::PaymentCreateV1Response]
      def create_payment(request_options: {}, **params)
        ...
        request = BridgeApi::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "/api/payments",
          body: BridgeApi::Payments::Types::PaymentCreateV1Request.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Payments::Types::PaymentCreateV1Response.load(response.body))
        else
          error_class = BridgeApi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [BridgeApi::Payments::Types::PaymentGetV1Response]
      def get_payment(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          (response.body.to_s.empty? ? nil : BridgeApi::Payments::Types::PaymentGetV1Response.load(response.body))
        else
          error_class = BridgeApi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
