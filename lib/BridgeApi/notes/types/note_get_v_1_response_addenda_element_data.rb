  ...
  module Notes
    module Types
      class NoteGetV1ResponseAddendaElementData < Internal::Types::Model
        ...
        field :monitoring_data, -> { Internal::Types::Array[BridgeApi::Notes::Types::NoteGetV1ResponseAddendaElementDataFieldMonitoringDatum] }, optional: true, nullable: false, api_name: "MONITORING_DATA"

        field :scored_assessments, -> { Internal::Types::Array[BridgeApi::Notes::Types::NoteGetV1ResponseAddendaElementDataFieldScoredAssessment] }, optional: true, nullable: false, api_name: "SCORED_ASSESSMENTS"
