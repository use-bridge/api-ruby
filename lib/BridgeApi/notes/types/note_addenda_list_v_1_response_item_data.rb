  ...
  module Notes
    module Types
      class NoteAddendaListV1ResponseItemData < Internal::Types::Model
        ...
        field :monitoring_data, -> { Internal::Types::Array[BridgeApi::Notes::Types::NoteAddendaListV1ResponseItemDataFieldMonitoringDatum] }, optional: true, nullable: false, api_name: "MONITORING_DATA"

        field :scored_assessments, -> { Internal::Types::Array[BridgeApi::Notes::Types::NoteAddendaListV1ResponseItemDataFieldScoredAssessment] }, optional: true, nullable: false, api_name: "SCORED_ASSESSMENTS"
