  ...
  module Notes
    module Types
      class NoteCreateV1ResponseAddendaElementData < Internal::Types::Model
        ...
        field :monitoring_data, -> { Internal::Types::Array[BridgeApi::Notes::Types::NoteCreateV1ResponseAddendaElementDataFieldMonitoringDatum] }, optional: true, nullable: false, api_name: "MONITORING_DATA"

        field :scored_assessments, -> { Internal::Types::Array[BridgeApi::Notes::Types::NoteCreateV1ResponseAddendaElementDataFieldScoredAssessment] }, optional: true, nullable: false, api_name: "SCORED_ASSESSMENTS"
