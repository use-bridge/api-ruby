  ...
  module Notes
    module Types
      class NoteAddendumCreateV1RequestData < Internal::Types::Model
        ...
        field :monitoring_data, -> { Internal::Types::Array[BridgeApi::Notes::Types::NoteAddendumCreateV1RequestDataFieldMonitoringDatum] }, optional: true, nullable: false, api_name: "MONITORING_DATA"

        field :scored_assessments, -> { Internal::Types::Array[BridgeApi::Notes::Types::NoteAddendumCreateV1RequestDataFieldScoredAssessment] }, optional: true, nullable: false, api_name: "SCORED_ASSESSMENTS"
