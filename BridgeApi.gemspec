...
require_relative "lib/BridgeApi/version"
...
Gem::Specification.new do |spec|
  spec.name = "usebridge-api"
  spec.authors = ["BridgeApi"]
  spec.version = BridgeApi::VERSION
  spec.summary = "Ruby client library for the BridgeApi API"
  spec.description = "The BridgeApi Ruby library provides convenient access to the BridgeApi API from Ruby."
