...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["Bridge_api"]
  spec.version = Bridge_api::VERSION
  spec.summary = "Ruby client library for the Bridge_api API"
  spec.description = "The Bridge_api Ruby library provides convenient access to the Bridge_api API from Ruby."
